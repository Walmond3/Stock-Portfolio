...
def app():
    ...
    if uploaded_file is not None:
        ...
        selected_stock_name_1 = st.selectbox("Select Stock", list(stocks.keys()))
        selected_stock_code_1 = stocks[selected_stock_name_1]
        selected_indicator_1 = st.selectbox("Select Indicator",
        ...
        if compare:
            ...
            selected_stock_name_2 = st.selectbox("Select Stock", list(stocks.keys()), key="stock_select_2")
            selected_stock_code_2 = stocks[selected_stock_name_2]
            selected_indicator_2 = st.selectbox("Select Indicator",
        ...
        if compare:
            ...
            st.plotly_chart(fig2, use_container_width=True, key='Chart 2')
    else:
